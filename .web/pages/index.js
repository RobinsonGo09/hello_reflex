...
export default function Component() {
  ...
  <Container>
  <Box>
  {state.chat_history.map((feswwrkq, i) => (
  ...
  <HStack>
  <Input onChange={(_e0) => addEvents([Event("state.set_question", {value:_e0.target.value})], (_e0))} placeholder={`Ask a question`} sx={{"borderWidth": "1px", "padding": "1em", "boxShadow": "rgba(0, 0, 0, 0.15) 0px 2px 8px"}} type={`text`}/>
